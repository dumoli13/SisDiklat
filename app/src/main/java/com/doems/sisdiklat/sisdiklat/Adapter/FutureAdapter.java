...
import com.doems.sisdiklat.sisdiklat.ActivitySchedule.ModifScheduleActivity;
...
public class FutureAdapter extends RecyclerView.Adapter<FutureAdapter.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        @BindView(R.id.layout_cardFuture) RelativeLayout layout_cardFuture;
    ...
    public FutureAdapter(Map<String, ModelSchedule> scheduleMap,Context context){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.card_schedule_future, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.layout_cardFuture.setOnClickListener(new View.OnClickListener() {
            @Override
