...
public class FutureActivity extends Fragment {
    ...
    private Map<String, ModelSchedule> futureListMap = new LinkedHashMap<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_future, container, false);
    ...
    private void initRecycler(){
        mAdapter = new FutureAdapter(futureListMap, context);
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if(schedule!=null){
                    ...
                    if(System.currentTimeMillis()<startDate.getTime()){
                        ...
                        futureListMap.put(key, new ModelSchedule(key, event, roomID, roomName, speaker,
